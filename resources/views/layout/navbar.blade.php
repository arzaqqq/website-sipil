...
<nav class="bg-white sticky top-0 z-50 border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between ms-8 mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{Storage::url($logo->foto)}}" alt="logo" class="w-[180px]">
        </a>
        <button id="navbar-toggler" data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{url('/admin/login') }}" class="block py-3 px-4 text-[12px] md:text-[14px] text-gray-900 font-semibold rounded md:bg-transparent md:text-gray-700 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:text-gray-500 dark:bg-green-600 md:dark:bg-transparent" aria-current="page">Beranda</a>
                </li>
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar1" class="flex font-semibold text-[12px] md:text-[14px] items-center justify-between w-full py-3 px-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-green-500 dark:focus:text-white dark:border-green-700 dark:hover:bg-green-700 md:dark:hover:bg-transparent">Perkuliahan<svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <div id="dropdownNavbar1" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white hover:bg-green-500 md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Matakuliah</a>
                            </li>
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 hover:bg-green-500 dark:hover:bg-gray-600 dark:hover:text-white md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Kelas</a>
                            </li>
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 hover:bg-green-500 dark:hover:bg-gray-600 dark:hover:text-white md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Dokumen</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar2" class="flex font-semibold items-center text-[12px] md:text-[14px] justify-between w-full py-3 px-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-green-500 dark:focus:text-white dark:border-green-700 dark:hover:bg-green-700 md:dark:hover:bg-transparent">Penilaian <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
                    </button>
                    <div id="dropdownNavbar2" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white hover:bg-green-500 md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Soal</a>
                            </li>
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 hover:bg-green-500 dark:hover:bg-gray-600 dark:hover:text-white md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Sampel Jawaban</a>
                            </li>
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 hover:bg-green-500 dark:hover:bg-gray-600 dark:hover:text-white md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Evaluasi</a>
                            </li>
                            <li>
                                <a href="{{url('/admin/login') }}" class="block px-4 py-2 hover:bg-green-500 dark:hover:bg-gray-600 dark:hover:text-white md:hover:bg-green-500 md:hover:text-white lg:hover:bg-green-500 lg:hover:text-white">Hasil Penilaian</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    <a href="{{url('/admin/login') }}" class="block py-3 px-4 text-[12px] md:text-[14px] text-gray-900 font-semibold rounded md:bg-transparent md:text-gray-700 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:text-gray-500 dark:bg-green-600 md:dark:bg-transparent" aria-current="page">Survei</a>
                </li>
                <li class="flex items-center mx-2 bg-green-100 px-2 py-0.5 rounded-lg dark:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                    </svg>
                    <a href="{{url('/admin/login') }}" class="block py-3 px-4 text-[12px] md:text-[14px] text-gray-900 font-semibold rounded md:bg-transparent md:text-gray-700 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:text-gray-500 dark:bg-green-600 md:dark:bg-transparent" aria-current="page">Masuk</a>
                </li>
            </ul>
        </div>
    </div>
